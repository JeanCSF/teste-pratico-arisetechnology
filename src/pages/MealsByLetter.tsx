...
const RecipesByLetter = () => {
    const api = import.meta.env.VITE_LIST_BY_LETTER;
    ...
    const getRecipesByLetter = async () => {
        try {
    ...
    return (
        <main className='mt-20'>
            <h1 className="text-center text-yellow-300 font-bold">Meals with letter: {letter}</h1>
